...
<head>
    ...
    .nav-link-logout {
        /* Mantemos o vermelho para o logout, mas com estilo clean */
    ...
    .main-content {
        padding-top: 80px; 
        padding-left: 30px; /* Mais espaço lateral */
        padding-right: 30px;
        min-height: 100vh;
    }
    .modern-card { 
    ...
    .modern-card:hover { 
        ...
        box-shadow: 0 10px 30px rgba(0, 0, 0, 0.15); /* Sombra mais pronunciada no hover */
    }
    .card-icon {
        font-size: 2.5rem;
        margin-bottom: 10px;
